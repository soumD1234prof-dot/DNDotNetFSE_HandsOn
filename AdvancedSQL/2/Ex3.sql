...
SELECT * FROM Orders1 WHERE CustomerID = 1 AND OrderDate = '2023-01-15';

CREATE NONCLUSTERED INDEX IX_Orders1_CustomerID_OrderDate
ON Orders1 (CustomerID, OrderDate);
